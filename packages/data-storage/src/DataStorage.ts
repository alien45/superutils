...
// 	console.warn(
// 		'DataStorage: storage not supported. Writing data will not work. Using workaround to avoid error.',
// 	)
...
// 		data = !isMap(data) ? new Map(isArr2D(data) ? data : undefined) : data
// 		this.name = name
...
// 			Array.from(data).forEach(([key, value]) => existing.set(key, value))
...
// 		this.name
// 			&& this.save
// 			&& write(this.name, data, true, this.storage, silent)
// 	}
// }
