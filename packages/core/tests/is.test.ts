...
describe('isArrLike', () => {
	it('should return false when value is not Array/Set/Map', () => {
		expect(isArrLike({ a: false })).toEqual(false)
		expect(isArrLike('string')).toEqual(false)
		expect(isArrLike(2)).toEqual(false)
		expect(isArrLike(null)).toEqual(false)
		expect(isArrLike(true)).toEqual(false)
	})
	it('should return true when value is Array/Set/Map', () => {
		expect(isArrLike([1, 2, 3])).toEqual(true)
		expect(isArrLike<string, number>(new Map([[1, 'a']]))).toEqual(true)
