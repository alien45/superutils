...
import { arrReverse } from './arrReverse'
 ...
 * ```
 */
export function arrSort<V extends Record<PropertyKey, unknown>>(
	arr: V[],
	key: keyof V & string,
	config?: SortConfig,
): V[]
...
export function arrSort<K extends PropertyKey, V = Record<K, unknown>>(
	arr: V[],
