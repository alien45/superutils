...
- [CurriedArgs](type-aliases/CurriedArgs.md)
...
- [SliceMapCallback](type-aliases/SliceMapCallback.md)
- [SliceMapOptions](type-aliases/SliceMapOptions.md)
...
- [getEntries](functions/getEntries.md)
...
- [matchItemOrProp](functions/matchItemOrProp.md)
