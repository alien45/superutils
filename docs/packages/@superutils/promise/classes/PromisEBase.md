...
Defined in: [packages/promise/src/PromisEBase.ts:5](https://github.com/alien45/utiils/blob/4acac077d6c90ce235cd4eb775ddbbb207554437/packages/promise/src/PromisEBase.ts#L5)
...
[`IPromisE`](../interfaces/IPromisE.md)\<`Awaited`\<`T`\[`number`\]\>\>
