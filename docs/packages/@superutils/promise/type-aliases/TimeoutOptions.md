# Type Alias: TimeoutOptions\<Func\>
...
(optional) name of the supported `PromieBase` static method. Default: `"all"`
...
(optional) timeout error message. Default: `"Timed out after 10000ms"`
