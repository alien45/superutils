...
- [TimeoutFunc](type-aliases/TimeoutFunc.md)
- [TimeoutOptions](type-aliases/TimeoutOptions.md)
...
- [deferredCallback](functions/deferredCallback.md)
- [delay](functions/delay.md)
- [delayReject](functions/delayReject.md)
