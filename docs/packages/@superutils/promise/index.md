...
- [PromisEBase](classes/PromisEBase.md)

## Interfaces

- [FetchResult](interfaces/FetchResult.md)
- [IPromisE](interfaces/IPromisE.md)
- [IPromisE\_Delay](interfaces/IPromisE_Delay.md)
...
- [FetchRetryConf](type-aliases/FetchRetryConf.md)
- [Interceptor](type-aliases/Interceptor.md)
- [IPromisE\_Timeout](type-aliases/IPromisE_Timeout.md)
- [OnEarlyFinalize](type-aliases/OnEarlyFinalize.md)
- [PostArgs](type-aliases/PostArgs.md)
- [PostBody](type-aliases/PostBody.md)
- [PromiseParams](type-aliases/PromiseParams.md)
...
- [PromisE\_deferred](functions/PromisE_deferred.md)
- [PromisE\_deferredCallback](functions/PromisE_deferredCallback.md)
- [PromisE\_deferredFetch](functions/PromisE_deferredFetch.md)
- [PromisE\_deferredPost](functions/PromisE_deferredPost.md)
- [PromisE\_delay](functions/PromisE_delay.md)
- [PromisE\_delayReject](functions/PromisE_delayReject.md)
- [PromisE\_timeout](functions/PromisE_timeout.md)

## References

### default

Renames and re-exports [PromisE](classes/PromisE.md)
